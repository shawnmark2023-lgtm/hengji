...
恒迹是一款本地优先的跨平台消费价值管理应用，目标平台为 iOS、Android、Windows 和 macOS。它把流水、产品资产、使用记录、二手残值和可解释洞察连接起来，让用户同时看到“花了多少”和“是否值得”。
...
- 流水新增/编辑、资产与日均/单次使用成本、手工二手报价与即时残值重算、应用内出售目标价关注、支出占比和可解释建议；手工/示例行情始终标注为非实时，目标价不会由示例或过期报价触发。
