...
- `hengji-android-debug.apk`：25,842,591 bytes；SHA-256 `E68A2E1C01FE9E77D92B78A9EB10C39D572B02CC8427D164B18D66A2A724019A`。由当前源码的 strict Debug 构建生成，包含手工二手报价入口；`apksigner` 验证 v2 签名通过，证书主题为 `C=US, O=Android, CN=Android Debug`，证书 SHA-256 为 `d740d66c573b4954e0a78e3a97034a45fd50e69310a0b289c4f9135f0ff4542b`；未在设备安装或启动。
