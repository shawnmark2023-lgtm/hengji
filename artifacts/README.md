...
- `hengji-android-debug.apk`：26,313,100 bytes；SHA-256 `E58A5F709025CF3895732380BD4328542BC90F079061A8811F71779861F7CB2A`。由当前源码的 strict Debug 构建生成，`apksigner` 验证 v2 签名通过，证书主题为 `C=US, O=Android, CN=Android Debug`，证书 SHA-256 为 `d740d66c573b4954e0a78e3a97034a45fd50e69310a0b289c4f9135f0ff4542b`；未在设备安装或启动。
